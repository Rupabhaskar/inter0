...
export const metadata = {
  title: "Select Test",
  description:
    "Choose your exam mock tests for JEE Main, JEE Advanced, AP EAMCET and college internal exams.",
  openGraph: {
    type: "website",
    title: "Select Test | RankSprint",
    description:
      "Choose your exam mock tests for JEE Main, JEE Advanced, AP EAMCET and college internal exams.",
    url: `${siteUrl}/select-test`,
  },
  twitter: {
  ...
  alternates: { canonical: `${siteUrl}/select-test` },
